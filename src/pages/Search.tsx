  ...
  return (
    <div className="max-w-4xl mx-auto p-6 mt-6">
      <div className="relative mb-10">
        ...
        <input
          type="text"
          placeholder="Введите название фильма (от 3 символов)..."
          value={query}
      ...
      {loading && <div className="text-center text-blue-400 text-lg animate-pulse">Ищем фильмы...</div>}

      {!loading && movies.length === 0 && query.trim().length >= 3 && (
        <div className="text-center text-slate-500 text-lg mt-10">По запросу "{query}" ничего не найдено</div>
      )}
